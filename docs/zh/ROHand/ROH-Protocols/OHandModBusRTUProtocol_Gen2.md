...
| ROH_FINGER_STALL_CURRENT3      |       1198 | R/W       | 200                | 无名指弯曲电机堵转停机电流限制值（uint16），单位 mA，开机时恢复为默认值                                                          |
| ROH_FINGER_STALL_CURRENT4      |       1199 | R/W       | 200                | 小指弯曲电机堵转停机电流限制值（uint16），单位 mA，开机时恢复为默认值                                                            |
| ROH_FINGER_STALL_CURRENT5      |       1200 | R/W       | 200                | 大拇指旋转电机堵转停机电流限制值（uint16），单位 mA，开机时恢复为默认值                                                          |
| ROH_FINGER_STALL_CURRENT6      |       1201 | R/W       |                    | 保留                                                                                                                             |
| ROH_FINGER_STALL_CURRENT7      |       1202 | R/W       |                    | 保留                                                                                                                             |
| ROH_FINGER_STALL_CURRENT8      |       1203 | R/W       |                    | 保留                                                                                                                             |
| ROH_FINGER_STALL_CURRENT9      |       1204 | R/W       |                    | 保留                                                                                                                             |
...
| ROH_FINGER_RETRY_AFTER_PERIOD0 |       1215 | R/W       | 500                | 大拇指弯曲电机堵转停机重试时间（uint16），单位 ms，开机时恢复为默认值                                                            |
| ROH_FINGER_RETRY_AFTER_PERIOD1 |       1216 | R/W       | 500                | 食指弯曲电机堵转停机重试时间（uint16），单位 ms，开机时恢复为默认值                                                              |
| ROH_FINGER_RETRY_AFTER_PERIOD2 |       1217 | R/W       | 500                | 中指弯曲电机堵转停机重试时间（uint16），单位 ms，开机时恢复为默认值                                                              |
| ROH_FINGER_RETRY_AFTER_PERIOD3 |       1218 | R/W       | 500                | 无名指弯曲电机堵转停机重试时间（uint16），单位 ms，开机时恢复为默认值                                                            |
| ROH_FINGER_RETRY_AFTER_PERIOD4 |       1219 | R/W       | 500                | 小指弯曲电机堵转停机重试时间（uint16），单位 ms，开机时恢复为默认值                                                              |
| ROH_FINGER_RETRY_AFTER_PERIOD5 |       1220 | R/W       | 500                | 大拇指旋转电机堵转停机重试时间（uint16），单位 ms，开机时恢复为默认值                                                            |
| ROH_FINGER_RETRY_AFTER_PERIOD6 |       1221 | R/W       |                    | 保留                                                                                                                             |
| ROH_FINGER_RETRY_AFTER_PERIOD7 |       1222 | R/W       |                    | 保留                                                                                                                             |
| ROH_FINGER_RETRY_AFTER_PERIOD8 |       1223 | R/W       |                    | 保留                                                                                                                             |
| ROH_FINGER_RETRY_AFTER_PERIOD9 |       1224 | R/W       |                    | 保留                                                                                                                             |
...
| ROH_MANU_DATA0                 |       1265 | R/W       |                    | 厂商数据，设置时保存到非易失存储器                                                                                               |
| ROH_MANU_DATA1                 |       1266 | R/W       |                    | 厂商数据，设置时保存到非易失存储器                                                                                               |
| ROH_MANU_DATA2                 |       1267 | R/W       |                    | 厂商数据，设置时保存到非易失存储器                                                                                               |
| ROH_MANU_DATA3                 |       1268 | R/W       |                    | 厂商数据，设置时保存到非易失存储器                                                                                               |
| ROH_MANU_DATA4                 |       1269 | R/W       |                    | 厂商数据，设置时保存到非易失存储器                                                                                               |
| ROH_MANU_DATA5                 |       1270 | R/W       |                    | 厂商数据，设置时保存到非易失存储器                                                                                               |
| ROH_MANU_DATA6                 |       1271 | R/W       |                    | 厂商数据，设置时保存到非易失存储器                                                                                               |
| ROH_MANU_DATA7                 |       1272 | R/W       |                    | 厂商数据，设置时保存到非易失存储器                                                                                               |
| ROH_MANU_DATA8                 |       1273 | R/W       |                    | 厂商数据，设置时保存到非易失存储器                                                                                               |
| ROH_MANU_DATA9                 |       1274 | R/W       |                    | 厂商数据，设置时保存到非易失存储器                                                                                               |
| ROH_MANU_DATA10                |       1275 | R/W       |                    | 厂商数据，设置时保存到非易失存储器                                                                                               |
| ROH_MANU_DATA11                |       1276 | R/W       |                    | 厂商数据，设置时保存到非易失存储器                                                                                               |
| ROH_MANU_DATA12                |       1277 | R/W       |                    | 厂商数据，设置时保存到非易失存储器                                                                                               |
| ROH_MANU_DATA13                |       1278 | R/W       |                    | 保留                                                                                                                             |
| ROH_MANU_DATA14                |       1279 | R/W       |                    | 保留                                                                                                                             |
| ROH_MANU_DATA15                |       1280 | R/W       |                    | 保留                                                                                                                             |
| ROH_SPEED_CTRL_BRAKE_DISTANCE  |       1281 | R/W       | 1024               | 刹车距离（uint16），单位 ms，开机时恢复为默认值                                                                                  |
| ROH_SPEED_CTRL_ACCEL_DISTANCE  |       1282 | R/W       | 1024               | 加速距离（uint16），unit ms，开机时恢复为默认值                                                                                  |
| ROH_SPEED_CTRL_PID_SPEED_RATIO |       1283 | R/W       | 0.50 \* 100        | PID 速度系数\*100（uint16），开机时恢复为默认值                                                                                  |
