# ROH-Gen2-Demos  适用于ROH-AP001/AP002
...
- 当前支持的ROHand的有ROH-AP001、ROH-AP002系列.  
...
- **您需要根据您购买的灵巧手型号选择单维力或三维力，如果您购买的是AP001,请选择TACS_DOT_MATRIX，AP002选择TACS_3D_FORCE，随后选择左手或右手.**  
...
- **您需要根据您购买的灵巧手型号选择单维力或三维力，如果您购买的是AP001,请选择TACS_DOT_MATRIX，反之选择TACS_3D_FORCE，随后选择左手或右手.**  

- **视觉demo只可以识别手掌面对摄像头且手指向上的手势，其他姿势可能会导致识别不准确.**
...
安装完后需在glove_ctrled_hand.py中的第269行  
...
375行处修改find_comport("CH340")为"/dev/ttyUSB0"  
...
122行处修改find_comport("CH340")为"/dev/ttyUSB0"  
