...
[<u>ROH-A001/ROH-A002 用户手册</u>](https://www.oymotion.com/upload/files/20260302095456ROH-A002%E6%9C%BA%E5%99%A8%E4%BA%BA%E7%81%B5%E5%B7%A7%E6%89%8B-V1.1.3.pdf){: target="_blank"}
...
ROHand的ROS1支持是基于rohand_ros_pkg 功能包进行的, 以下为使用环境:  
...
ROHand的ROS2支持是基于rohand_ros2_pkg 功能包进行的, 以下为使用环境:  
...
ROHand的URDF ROS1支持是基于rohand_urdf_ros1 功能包进行的, 以下为使用环境:  

- 当前支持的ROHand系列的有: ROH-A001, ROH-A002.  
...
### 2. 下载 rohand_urdf_ros1

- 方法一: [点击此链接](../../../assets/downloads/ROHand/rohand_urdf_ros1-main.zip)下载

- 方法二: 访问[rohand_urdf_ros1](https://github.com/oymotion/rohand_urdf_ros1){: target="_blank"} github网址下载最新版本  
...
请访问[URDF README](../ROS/URDF_ROS1.md)获取更多信息.  
...
ROHand的URDF ROS2支持是基于rohand_urdf_ros2 功能包进行的, 以下为使用环境:  

- 当前支持的ROHand的有ROH-A001, ROH-A002.  
...
### 2. 下载rohand_urdf_ros2

- 方法一: [点击此链接](../../../assets/downloads/ROHand/rohand_urdf_ros2-main.zip)下载

- 方法二: 访问[rohand_urdf_ros2](https://github.com/oymotion/rohand_urdf_ros2){: target="_blank"} github网址下载最新版本  
...
请访问[URDF README](../ROS/URDF_ROS2.md)获取更多信息.  

![A001&A002](../imgs/lites_ros2.png)
...
- 方法一: [点击此链接](../../../assets/downloads/ROHand/A001&A002_mujoco.zip)下载
...
[点击此处](../MUJOCO/A001&A002.md) 获取更多信息  
