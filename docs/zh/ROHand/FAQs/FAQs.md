...
![ROHand_LS接线图](../imgs/wiring_CN.png)
...
接线方式如下图所示：
![ROHand_LSR接线图](../imgs/wiring_realman_CN.png)
...
参考:  
[点击此处](../../../assets/downloads/ROHand/roh_registers_v2.zip)获取roh_registers_v2.h/roh_registers_v2.py  
示例程序：[附录1](#appendix1)
...
详细定义请参考: [OHandModBusRTUProtocol_CN.md](../ROH-Protocols/OHandModBusRTUProtocol_Gen2.md)
...
1. 安装CH340驱动: [Download](../../../assets/downloads/ROHand/CH341SER.EXE)
...
<h3 id="appendix2">附录 2. 获取手指角度范围</h3>
...
<h3 id="appendix3">附录 3. 减少灵巧手堵转发热程序示例</h3>  
...
<h3 id="appendix4">附录 4. 灵巧手避免抖动和发热程序示例</h3>
...
<h3 id="appendix5">附录 5: 力量控制模式（注意力传感器仅在AP001/AP002上搭载）</h3>
