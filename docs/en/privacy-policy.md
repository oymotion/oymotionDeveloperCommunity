...
This website uses Baidu Tongji (Baidu Analytics) for traffic analysis.

Baidu Tongji collects anonymized IP addresses, device types, browser information, visited pages, and dwell time.
