...
gForcePro/gForcePro+ Armband or gForceOct module is a smart wearable [Human Interface Device][HID]{: target="_blank"} for
...
data in quaternions or [Euler Angles][EulerAngles]{: target="_blank"} from its built-in 9-axis [IMU][IMU]{: target="_blank"}.
...
- **Via SDK**
    ...
    Use [gForceSDKCXX](https://github.com/oymotion/gForceSDKCXX){: target="_blank"}, [gForceSDKCSharp](https://github.com/oymotion/gForceSDKCSharp){: target="_blank"}, [gForceSDKPython](https://github.com/oymotion/gForceSDKPython){: target="_blank"} to fetch EMG data, etc.
...
[Click here](../../assets/downloads/gForce/gForce-EMG-ARMBAND-User-Guide-202108.pdf){: target="_blank"} for gForcePro+/gForceOct user guide in PDF format.
