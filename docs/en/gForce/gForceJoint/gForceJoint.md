...
Before continuing, please make sure you have sufficient experience with [Arduino](https://www.arduino.cc/){: target="_blank"}, and [ArduinoIDE](https://www.arduino.cc/en/Main/Software){: target="_blank"} was installed on your PC.

* [What is Arduino](https://www.arduino.cc/en/Guide/Introduction){: target="_blank"}
* [How to install ArduinoIDE](https://www.arduino.cc/en/Main/Software){: target="_blank"}
* [Learn Arduino](https://www.arduino.cc/en/Reference/HomePage){: target="_blank"}
...
* [What is gForceSDKArduino](https://github.com/oymotion/gForceSDKArduino){: target="_blank"}
* [What is ArduinoMEGA](https://www.arduino.cc/en/Main/arduinoBoardMega){: target="_blank"}

![gForceAndArduino](imgs/gForceAndArduino_En.png)

### Step 1: Import gForceSDKArduino  

* [How to import gForceSDKArduino](https://github.com/oymotion/gForceSDKArduino){: target="_blank"}
...
2. Open [gForceJointTest](https://github.com/oymotion/gForceSDKArduino/blob/master/examples/gForceJointTest/gForceJointTest.ino){: target="_blank"} in ArduinoIDE. Compile and upload to ArduinoMEGA.
...
If a gForce-100/gForce-200 is used, users should follow [wearing instruction](https://oymotion.github.io/assets/downloads/gForce100_manual_v1.1-eng.pdf){: target="_blank"} and gesture strictly.
