...
|                                            RS485                                             |                                           CAN                                            |
| :------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------: |
| [![RS485](./imgs/灵巧手开箱视频封面.png)](./imgs/RS485灵巧手开箱视频.mp4){: target="_blank"} | [![CAN](./imgs/灵巧手开箱视频封面.png)](./imgs/CAN灵巧手开箱视频.mp4){: target="_blank"} |
...
[<u>View</u>](../../assets/downloads/ROHand/OHandSetting-Instruction-Manual-V1.4.pdf){: target="_blank"}

## Host Computer Video Tutorial

[![Windows](./imgs/HostComputer_img_en.png)](./img/HostComputer_en.mp4){: target="_blank"}
