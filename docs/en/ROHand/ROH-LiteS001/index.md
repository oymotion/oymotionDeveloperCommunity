...
[<u>ROH-LiteS001 User Manual</u>](../imgs/ROH-LiteS001-Dexterous-Hand-V1.0.7.pdf){: target="_blank"}
...
ROHand's URDF ROS1 support is based on the [rohand_lites_urdf_ros1](https://github.com/oymotion/rohand_lites_urdf_ros1){: target="_blank"} package, the following is the usage environment:  

- The currently supported ROHHand series include ROH-LiteS001.
...
### 2. Download rohand_lites_urdf_ros1

- Method 1: [Click this link](../../../assets/downloads/ROHand/rohand_lites_urdf_ros1-main.zip) to download

- Method 2: Visit [rohand_lites_urdf_ros1](https://github.com/oymotion/rohand_lites_urdf_ros1){: target="_blank"} GitHub page to download the latest version  
...
Please visit [URDF README](../ROS/LITES_URDF_ROS1.md) for more details.  
...
ROHand's URDF ROS2 support is based on the [rohand_lites_urdf_ros2](https://github.com/oymotion/rohand_lites_urdf_ros2){: target="_blank"} package, the following is the usage environment:  
...
### 2. Download rohand_lites_urdf_ros2

- Method 1: [Click this link](../../../assets/downloads/ROHand/rohand_lites_urdf_ros2-main.zip) to download

- Method 2: Visit [rohand_lites_urdf_ros2](https://github.com/oymotion/rohand_lites_urdf_ros2){: target="_blank"} GitHub page to download the latest version  
...
Please visit [URDF README](../ROS/LITES_URDF_ROS2.md) for more details.  
...
- Method 1: [Click this link](../../../assets/downloads/ROHand/LiteS001_mujoco.zip) to download  
...
[Click this link](../MUJOCO/LiteS.md) to get more details

When running successfully, it should be as shown in the figure:  

![LiteS_mujoco](../imgs/LiteS_mujoco.png)