...
[<u>ROH-A001/ROH-A002 User Manual</u>](../imgs/ROH-A002-Dexterous-Hand-V1.1.4.pdf){: target="_blank"}

## Communication Protocol

[Serial&CAN](../ROH-Protocols/OHandSerialProtocol_Gen1.md)

[Modbus](../ROH-Protocols/OHandModBusRTUProtocol_Gen1.md)
...
- Method 1: [Click this link](../../../assets/downloads/ROHand/rohand_ros_pkg-main.zip) to download
...
Please visit [ROS1 README](../ROS/ROS1.md){: target="_blank"} for more details.
...
Please visit [ROS2 README](../ROS/ROS2.md){: target="_blank"} for more details.

## URDF ROS1

ROHand's URDF ROS1 support is based on the [rohand_urdf_ros1](https://github.com/oymotion/rohand_urdf_ros1){: target="_blank"} package, the following is the usage environment:  

- The currently supported ROHHand series include ROH-A001, ROH-A002.  
...
### 2. Download rohand_urdf_ros1

- Method 1: [Click this link](../../../assets/downloads/ROHand/rohand_urdf_ros1-main.zip) to download

- Method 2: Visit [rohand_urdf_ros1](https://github.com/oymotion/rohand_urdf_ros1){: target="_blank"} GitHub page to download the latest version  
...
Please visit [URDF README](../ROS/ROS1.md){: target="_blank"} for more details.  

When running successfully, it should be as shown in the figure  

![A001&A002](../imgs/A001_ros1.png)

## URDF ROS2

ROHand's URDF ROS2 support is based on the [rohand_urdf_ros2](https://github.com/oymotion/rohand_urdf_ros2){: target="_blank"} package, the following is the usage environment:  
...
### 2. Download rohand_urdf_ros2

- Method 1: [Click this link](../../../assets/downloads/ROHand/rohand_urdf_ros2-main.zip) to download

- Method 2: Visit [rohand_urdf_ros2](https://github.com/oymotion/rohand_urdf_ros2){: target="_blank"} GitHub page to download the latest version  
...
Please visit [URDF README](../ROS/URDF_ROS2.md){: target="_blank"} for more details.  

When running successfully, it should be as shown in the figure  

![A001&A002](../imgs/A001_ros2.png)
...
- Method 1: [Click this link](../../../assets/downloads/ROHand/roh_demos-main.zip)to download  
- Method 2: Visit [roh_demos](https://github.com/oymotion/roh_demos){: target="_blank"} GitHub page to download the latest version   
- Method 3: Obtain via clone:  
...
This example uses a computer camera to perform gesture recognition on the OYMotion dexterous hand, enabling it to control the dexterous hand based on the recognized gestures
...
This example controls the movement of the dexterous hand via a wireless Bluetooth glove or a wired glove
...
- Method 1: [Click this link](../../../assets/downloads/ROHand/ohand_serial_sdk-master.zip) to download  
- Method 2: Visit [ohand_serial_sdk](https://github.com/oymotion/ohand_serial_sdk) {: target="_blank"}GitHub page to download the latest version 
- Method 3: Obtain via clone:  
...
- Method 1: [Click this link](../../../assets/downloads/ROHand/A001&A002_mujoco.zip) to download  
...
[Click this link](../MUJOCO/A001&A002.md) to get more details

When running successfully, it should be as shown in the figure:  

![A001&A002_mujoco](../imgs/A001&A002_mujoco.png)