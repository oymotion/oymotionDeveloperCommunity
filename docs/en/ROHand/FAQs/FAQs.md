...
![ROHand_LS wiring](../imgs/wiring_EN.png)
...
Wiring diagram:  
![ROHand_LSR wiring](../imgs/wiring_realman_EN.png)
...
![wiring terminal](../imgs/wiring_terminal.png)
...
![120Ω resistor](../imgs/terminal_resistor.png)
...
Reference:  
[click here](../../../assets/downloads/ROHand/roh_registers_v2.zip) get roh_registers_v2.h/roh_registers_v2.py  
...
Protocol: [OHandModBusRTUProtocol_EN.md](../ROH-Protocols/OHandModBusRTUProtocol_Gen2.md)
...
- Note, the force sensor is only equipped on AP001/AP002
...
![ROH-AP001 Sensor Map](../imgs/force_dot.png)
...
- **Force Control:** Finger force feedback. The force sensor is only equipped on AP001/AP002
...
1. Install CH340 driver: [Download](../../../assets/downloads/ROHand/CH341SER.EXE)
...
### 11. Q: How do I use force control mode? (The force sensor is only equipped on AP001/AP002
